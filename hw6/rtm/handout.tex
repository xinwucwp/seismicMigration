...
\sideplot{imag0rb}{width=\textwidth}{Image migrated with the recorded data in
Figure~\ref{fig:dr0} and the constant density \texttt{rb.rsf}.}
\sideplot{imag1rb}{width=\textwidth}{Image migrated with the recorded data in
Figure~\ref{fig:dr1} and the constant density \texttt{rb.rsf}.}
...
%\sideplot{ra}{width=\textwidth}{The variable density \texttt{ra.rsf}.}
\sideplot{imag0ra}{width=\textwidth}{Image migrated with the recorded data in
Figure~\ref{fig:dr0} and the variable density \texttt{ra.rsf}.}
\sideplot{imag1ra}{width=\textwidth}{Image migrated with the recorded data in
Figure~\ref{fig:dr1} and the variable density \texttt{ra.rsf}.}
...
\lstinputlisting[backgroundcolor=\color{gray},firstline=91,lastline=109,
firstnumber=91]{exercise/SConstruct}
\lstinputlisting[firstline=110,firstnumber=110,lastline=110]{exercise/SConstruct}
\normalsize
